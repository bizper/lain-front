                ...
                <div className="flex flex-col items-center justify-center w-full h-full">
                    ...
                    <div className="flex w-full items-center justify-center h-full">
                        <div className="max-w-[50vw] flex-1 flex flex-col gap-8 items-center justify-center">
                            <img alt='cover' className='w-[60%] aspect-square object-fill rounded-2xl shadow-[5px_10px_10px_rgba(0,0,0,0.2)] transition-transform duration-500 hover:scale-[1.02]' src={url + "/play/getCover/" + song?.cover}></img>
